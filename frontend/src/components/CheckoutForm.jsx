                    ...
                    <h3 className='border-bottom pb-3'><strong>Billing Details</strong></h3>                   
                        <div className="row pt-3">
                            ...
                            <div className="mb-3">
                                ...
                                {
                                    errors.email && <p className='invalid-feedback'>{errors.address?.message}</p>
                                } 
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className='mb-3'>
                                    ...
                                    placeholder='City' />
                                    {
                                        errors.email && <p className='invalid-feedback'>{errors.city?.message}</p>
                                    } 
                                </div>
                            </div>
                ...
                <div className="col-md-5">
                    ...
                    <div  className='pt-2'>
                        <input 
                            ...
                            value={'stripe'} 
                        />
                        <label htmlFor="" className='from-control ps-2'>Stripe</label>
                        ...
                        />
                        <label htmlFor="" className='from-control ps-2'>COD</label>
                    </div>
                    ...
                    <div className="d-flex py-3">
                        <button disabled={loading} className="btn btn-primary text-uppercase">
